...
class InterfazApp:
    def __init__(self, root):
        ...
        self.step = 0  # Paso 0: Pantalla inicial
        self.imagen_hdr = ""
        self.shapefile_path = ""
    ...
    # Step 0: Pantalla Inicial (Selección de Tipo de Procesamiento)
    ...
    def iniciar_procesamiento_rgb(self):
        # Limpiamos la ventana actual y mostramos la interfaz de segmentación de hojas
        self.clear_container()
    ...
    def show_step_1(self):
        ...
        self.var_vector = tk.BooleanVar(value=True)  # Shapefile es obligatorio
    ...
    def procesar_paso_1(self):
        ...
        print(f"Shapefile path generado: {self.shapefile_path}")  # Depuración
    ...
    def procesar_paso_2(self):
        ...
        print(f"Imagen recortada path: {self.imagen_recortada_path}")  # Depuración
    ...
    def show_step_3(self):
        ...
        ttk.Label(self.container, text="Ruta para guardar Excel:").grid(row=5, column=0, pady=5)
        self.excel_entry = ttk.Entry(self.container, width=50)
        self.excel_entry.grid(row=5, column=1, pady=5)
        ttk.Button(self.container, text="Buscar", command=lambda: self.excel_entry.insert(0, self.seleccionar_archivo("excel"))).grid(row=5, column=2, pady=5)
    ...
    def procesar_paso_3(self):
        ...
        self.root.update_idletasks()
        try:
            procesar_shapefile_y_extraer_datos(self.shapefile_path, self.imagen_recortada_path, puntos, excel_path, clusters)
        except Exception as e:
